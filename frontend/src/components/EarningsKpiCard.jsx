...
export default function EarningsKpiCard({ title = "Earnings", value, chartData }) {
  return (
    <div className="bg-gray-900 rounded-xl p-6 flex flex-col justify-between w-full max-w-xs shadow-lg">
      ...
      <h2 className="text-white text-3xl font-extrabold mb-5 select-none">{formatDollars(value)}</h2>
      {chartData && (
